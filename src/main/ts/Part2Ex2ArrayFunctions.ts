...
export const runEach2 = (): void => {
  // Use Arr.each and console.log to print the name of each frog
...
export const isSomeRibbitting = (frogs: Frog[]): boolean =>
...
export const isSomeNeg = (numbers: number[]): boolean =>
  Arr.exists(numbers, (x) => x < 0);
